...
+ function($) {
    ...
    var Picker = function (params) {
        ...
        p.initPickerCol = function (colElement, updateItems) {
            ...
            var isTouched, isMoved, touchStartY, touchCurrentY, touchStartTime, touchEndTime, startTranslate, returnTo, currentTranslate, prevTranslate, velocityTranslate, velocityTime, targetTouches;
            function handleTouchStart (e) {
                if (isMoved || isTouched) return;
                targetTouches = e.targetTouches || e.originalEvent.targetTouches;
                e.preventDefault();
                isTouched = true;
                touchStartY = touchCurrentY = e.type === 'touchstart' ? targetTouches[0].pageY : e.pageY;
            ...
            function handleTouchMove (e) {
                ...
                touchCurrentY = e.type === 'touchmove' ? targetTouches[0].pageY : e.pageY;
                if (!isMoved) {
                    // First move
                    $.cancelAnimationFrame(animationFrameId);
                    isMoved = true;
